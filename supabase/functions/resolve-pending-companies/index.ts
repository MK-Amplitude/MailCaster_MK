...
4) parent_group (그룹사) — 한국 기업집단명. 한글로 짧게.
   ★ 정책: 자회사·계열사뿐 아니라 "여러 계열사를 거느린 그룹의 대표/지주 법인 자체" 도 그 그룹명으로 표기.
      그 회사가 기업집단(그룹)의 일원이면 — 지주사든 자회사든 대표 법인이든 — 그룹명을 채운다.
      계열사가 없는 진짜 단일 독립기업만 parent_group=null.
   - 그룹 대표법인 자체도 표기: "kt" → "KT", "비바리퍼블리카" → "토스", "주식회사 카카오" → "카카오", "네이버(주)" → "네이버".
   - 알려진 그룹사(이에 한정되지 않음): 롯데, 신세계, 삼성, 현대, 현대백화점, LG, SK, GS, 한화, CJ, 카카오, 네이버, KT, 두산, 코오롱, 효성, 포스코, 농심, 오리온, 미래에셋, 골프존, 이랜드, SPC, 하림, 빙그레, 종근당, 한미약품, 셀트리온, 넥슨, 엔씨소프트, 넷마블, 크래프톤, NHN, 토스(비바리퍼블리카), 쿠팡, 우아한형제들, 야놀자, 하이브, HD현대, KB금융, 신한금융, 하나금융, 우리금융, 등
   - 매핑 예시:
       "롯데캐피탈" → parent_group="롯데"
       "신세계라이브쇼핑" / "이마트" / "SSG.COM" / "스타벅스코리아" / "신세계아이앤씨" / "SHINSEGAE I&C" → parent_group="신세계"
       "CJ제일제당" / "CJ ENM" / "CJ올리브영" → parent_group="CJ"
       "GS리테일" / "GS칼텍스" → parent_group="GS"
       "SK텔레콤" / "SK하이닉스" / "SK주식회사" → parent_group="SK"
       "카카오엔터테인먼트" / "카카오스타일" / "카카오헬스케어" → parent_group="카카오"
       "kt" / "주식회사 KT" / "KT엠모바일" / "KT클라우드" / "BC카드" / "케이뱅크" → parent_group="KT"
       "비바리퍼블리카" / "토스" / "토스뱅크" / "토스증권" / "토스페이먼츠" → parent_group="토스"
       "쿠팡" / "쿠팡페이" / "쿠팡플레이" / "쿠팡이츠" → parent_group="쿠팡"
